...
def run(repo_dir:str, data_dir:str='~/pedagogia-code-questions/data'):
    ...
    group_dir = os.path.join(os.path.expanduser(data_dir), repo_name)
    ...
    with open(f'{group_dir}/result_noisy_question_single_chunk_embed_description.json', 'w') as outfile:
