...
class RepoKnowledgeGraph:
    ...
    @classmethod
    def from_dict(cls, data_dict, index_nodes:bool=True, use_embed:bool=False):
    ...
    @classmethod
    def load_graph_from_file(cls, filepath: str, use_embed:bool = False):
        with open(filepath, 'r') as f:
            data = json.load(f)
        return cls.from_dict(data, use_embed=use_embed)
